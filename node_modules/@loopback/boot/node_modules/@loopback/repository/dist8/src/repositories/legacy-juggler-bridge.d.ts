...
import { Options, AnyObject, Command, NamedParameters, PositionalParameters } from '../common-types';
import { Entity } from '../model';
import { Filter, Where } from '../query';
import { EntityCrudRepository } from './repository';
import { HasManyRepositoryFactory } from './relation.factory';
...
export declare class DefaultCrudRepository<T extends Entity, ID> implements EntityCrudRepository<T, ID> {
     ...
     */
    protected _createHasManyRepositoryFactoryFor<Target extends Entity, TargetID>(relationName: string, targetRepo: EntityCrudRepository<Target, TargetID>): HasManyRepositoryFactory<Target, ID>;
