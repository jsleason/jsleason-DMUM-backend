 ...
 */
export declare function getOAIPrimitiveType(type?: string, format?: string): "string" | "number" | "binary" | "boolean" | "date" | "integer" | "float" | "double" | "byte" | "date-time" | "password" | "serialize" | "long" | undefined;
