...
export declare function stubServerRequest(options: ShotRequestOptions): ServerRequest;
...
export declare function stubServerResponse(request: ServerRequest, onEnd: ShotCallback): ServerResponse;
