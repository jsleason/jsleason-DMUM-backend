...
export declare type HasManyRepositoryFactory<Target extends Entity, SourceID> = (fkValue: SourceID) => HasManyRepository<Target>;
/**
 ...
 */
export declare function createHasManyRepositoryFactory<SourceID, Target extends Entity, TargetID>(relationMetadata: HasManyDefinition, targetRepository: EntityCrudRepository<Target, TargetID>): HasManyRepositoryFactory<Target, SourceID>;
