...
import { HasManyEntityCrudRepository } from './relation.repository';
 ...
 *
 */
export declare function hasManyRepositoryFactory<SourceID, T extends Entity, ID>(sourceModelId: SourceID, relationMetadata: HasManyDefinition, targetRepository: EntityCrudRepository<T, ID>): HasManyEntityCrudRepository<T>;
