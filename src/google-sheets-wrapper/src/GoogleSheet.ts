...
export class GoogleSheet {
    ...
    private async writeToGoogle(values: any) {
        return new Promise((resolve, reject) => {
    ...
    private async authenticate() {
        return new Promise((resolve, reject) => {
            ...
            this.authFactory.getApplicationDefault((err: any, authClient: any) => {
                if (err) {
